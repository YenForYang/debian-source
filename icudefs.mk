...
CFLAGS =  -W4 -W4 $(THREADSCFLAGS) 
# CXXFLAGS is for C++ only flags
CXXFLAGS =  $(THREADSCXXFLAGS) 
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS =  $(THREADSCPPFLAGS)  -DHAVE_DLOPEN=0 -DU_HAVE_MMAP=0 -DU_HAVE_POPEN=0 -DU_HAVE_STRTOD_L=0 
...
include $(top_srcdir)/config/mh-msys-msvc
